...
I am choosing to move forward with the DigitalRegister component for several reasons. First, it alings with my academic interests in digital design, computer architecture, and core ECE concepts. A digital register is a fundamental hardware abstraction used in processors, embedded systems, data paths, making it both technically meaningful and relevent to my academic knowledge.

The scope of this component is also realistic for a single semester. The kernel operations (bit manipulation) are small and well defind, while the secondary operations like shifting, incrementing, integer conversion demonstrate abstraction.

This design will allow me to explore hardware-accurate behavior in a software environment helping me reinforce my understanding of both areas.
